...
INSERT INTO `admin` (`admin_id`, `first_name`, `last_name`, `email_id`, `user_name`, `password`, `mobile_no`) VALUES
(1, 'Amit', 'Kumar', 'ay@gmail.com', 'admin', '12345', '7275409046');
...
INSERT INTO `employee` (`employee_id`, `first_name`, `last_name`, `mobile_number`, `email`, `username`, `password`, `status`) VALUES
(12, 'Sandeep Kumar', 'Dubey', '9506032539', 'sand@gmail.com', 'sandeep', '123456789', 0),
(13, 'Saurav', 'Tiwari', '1234567890', 'ad@gmail.com', 'saurav', 'asdfghjkl', 0),
(14, 'Saurabh', 'Rai', '1234567898', 's@gmail.com', 'saurabh', '12345678', 1);
...
--
-- Table structure for table `register_clinic`
--

CREATE TABLE `register_clinic` (
  `id` int(255) NOT NULL,
...
--
-- Dumping data for table `register_clinic`
--

INSERT INTO `register_clinic` (`id`, `labname`, `first_name`, `last_name`, `phone`, `address`, `country`, `state`, `stltype`, `email`, `password`, `status`) VALUES
(1, 'Rahul Lab', 'Rahul', 'Singh', 2147483647, '', 0, '', '', 'ngh@gmail.com', 'asdfghjkl', 1),
(2, 'Abhay Clinic', 'Abhay', ' Clinic', 2147483647, 'Faridabad', 99, 'UP', '', 'rtrt@gmail.com', 'asdfghjkl', 1),
(3, 'Ratnakar Lab', 'Ratnakar', 'Singh', 2147483647, 'azad nagar', 99, 'zip', ' Sirona, 3 Shape, iTero STL', 'dik@gmail.com', 'asdfghjkl', 1),
(4, 'Ramesh Kumar', 'Ramesh ', 'Kumar', 2147483647, 'aswdef', 1, 'kabul', ' Sirona, 3 Shape, iTero STL', 'dj@gmail.com', 'asdfghjkl', 0);

-- --------------------------------------------------------

--
-- Table structure for table `stlfile`
--

CREATE TABLE `stlfile` (
  `stl_id` int(255) NOT NULL,
  `stl_name` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `stlfile`
--

INSERT INTO `stlfile` (`stl_id`, `stl_name`) VALUES
(1, 'Sirona'),
(2, '3 Shape'),
(3, 'iTero STL'),
(4, 'Dental Wings'),
...
--
-- Table structure for table `working-_time`
--

CREATE TABLE `working-_time` (
  `work_id` int(255) NOT NULL,
  `time` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `working-_time`
--

INSERT INTO `working-_time` (`work_id`, `time`) VALUES
(1, 'Next Day 7 am'),
(2, 'Six Hours'),
(3, 'Two Hours');
...
--
-- Indexes for table `register_clinic`
--
ALTER TABLE `register_clinic`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `stlfile`
--
ALTER TABLE `stlfile`
  ADD PRIMARY KEY (`stl_id`);

--
-- Indexes for table `working-_time`
--
ALTER TABLE `working-_time`
...
--
-- AUTO_INCREMENT for table `stlfile`
--
ALTER TABLE `stlfile`
  MODIFY `stl_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `working-_time`
--
ALTER TABLE `working-_time`
  MODIFY `work_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `work_status`
--
ALTER TABLE `work_status`
  MODIFY `work_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
