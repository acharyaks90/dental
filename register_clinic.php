...
<div class="col-12 grid-margin">
        ...
        $pass = random_strings(8);
          ...
          '".$_POST['STATE']."','$chkstr','".$_POST['EMAILADD']."','$pass')";
					$result = mysqli_query($db,$sql) or die(mysqli_error($db));

         function sendMail($email,$password) {
           return `<div>
            <p>Your email has been registered successfully with PD24*7</p>
            <p> Your current password is : ${password}. </p>
            <p> Please use this password to login to your account </p>
            <p> After logging into your account please change the password for security reasons</p>
            <p> Thank you for starting your buisness with us </p>
           </div>`;
         }
