                ...
                <div class="panel-heading">
                	<div class="row">
                    	<div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            <h3 class="panel-title">My Employee </h3>
                        </div>
					...
					<thead>
							<tr>
								...
								<th>Delete</th>
                                 ...
                                 $sql="select * from employee order by employee_id  ASC LIMIT $start_from, $limit ";
                                     ...
                                     ?>									
										  ...
										  <tr>
											   ...
											   <td> <a href="employee_profile.php?employee_id=<?php echo $row['employee_id'];?>" class="btn btn-primary">View</a></td>
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='viewteacher.php?page=".$i."'>".$i."</a></li>";  
};  
