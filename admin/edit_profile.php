  ...
  <span id="alert_action"></span>
	<div class="row">
		<div class="col-lg-12" style="font-size:18px;">
            ...
            <?php   
			 ...
			 $admin_id=$_GET["admin_id"];
                $res=mysqli_query($db,"select * from admin where admin_id='$admin_id'");
     ...
     if(isset($_POST["b1"]))
	 {
			...
			$row= mysqli_query($db,"update ignore admin set first_name='$_POST[fn]',last_name='$_POST[ln]', email_id='$_POST[em]', mobile_no='$_POST[mn]'    where admin_id='$admin_id'");
