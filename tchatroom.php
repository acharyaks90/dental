...
?><?php   
                         $_SESSION['tid']=$teacher_id=$_GET['teacher_id']; 
						 
						 
						$run=mysqli_query($db,"select * from staff where teacher_id='$teacher_id' ");
...
<div class="col-md-12">
		...
		<div class="col-sm-4">
				   <div class="panel panel-default" style="height: 350px;" >
					...
					<span style="font-size:20px;color:red"><b>Teacher : <?php echo  $tname; ?></b></span>
					<div style="height:5px;"></div>
					<span style="font-size:16px; margin-left:5px;padding:2px;color:skyblue">Subject :<?php echo  $subject; ?> </span><br></center>
