  ...
  <div class="row">
        ...
        <div class="col-md-12">
			...
			<?php 
	                 ...
	                 $sql="select * from videos where upload_by='$user' order by video_id  DESC LIMIT  $limit";
	...
	?>
               ...
               <source src="upload/<?php echo $row['location']; ?>" type="video/mp4"></video></a>
				...
				<div class="recommended">
					...
					$limit = 4;  
	                 $sql="select * from videos  where subject='Operating System' AND upload_by='$user' order by video_id  desc LIMIT  $limit";
                     $rs=mysqli_query($db,$sql); 
                     while($row=mysqli_fetch_array($rs))	
                     {
	...
	?>
               ...
               <source src="upload/<?php echo $row['location']; ?>" type="video/mp4"></video>
					...
					$limit = 4;  
	                 ...
	                 $sql="select * from videos  where subject='Data Structure' AND upload_by='$user' order by video_id  desc LIMIT  $limit";
                     $rs=mysqli_query($db,$sql); 
                     while($row=mysqli_fetch_array($rs))	
                     {
	...
	?>
               ...
               <source src="upload/<?php echo $row['location']; ?>" type="video/mp4"></video>
					...
					$limit = 4;  
	                 ...
	                 $sql="select * from videos  where subject='Digital Logic Design' AND upload_by='$user' order by video_id  desc LIMIT  $limit";
                     $rs=mysqli_query($db,$sql); 
                     while($row=mysqli_fetch_array($rs))	
                     {
	...
	?>
               ...
               <source src="upload/<?php echo $row['location']; ?>" type="video/mp4"></video>
					...
					$limit = 4;  
	                 ...
	                 $sql="select * from videos  where subject='Theory Of Computation' AND upload_by='$user' order by video_id  desc LIMIT  $limit";
                     $rs=mysqli_query($db,$sql); 
                     while($row=mysqli_fetch_array($rs))	
                     {
	...
	?>
               ...
               <source src="upload/<?php echo $row['location']; ?>" type="video/mp4"></video>
					...
					$limit = 4;  
	                 ...
	                 $sql="select * from videos  where subject='Compiler Design' AND upload_by='$user' order by video_id  desc LIMIT  $limit";
                     $rs=mysqli_query($db,$sql); 
                     while($row=mysqli_fetch_array($rs))	
                     {
