	...
	?>
					...
					<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
						...
						<h5 style="color:black; font-size:18px;"><?php echo $row['title']; ?></h5>
												...
												<div class="slid-bottom-grids">
													<div class="slid-bottom-grid">
														<p class="views views-info btn btn-primary"  ><a  style="color:white;text-decoration:none;" href="updatenotes.php?id=<?php echo $row['id']; ?>" >Update </a></p>
													</div>
													<div class="slid-bottom-grid slid-bottom-right">
											<p class="views views-info btn btn-danger"  ><a  style="color:white;text-decoration:none;" href="deletenotes.php?id=<?php echo $row['id']; ?>" >Delete </a></p>			</div>
													<div class="clearfix"> </div>
												</div>
											</div>
					</div>
