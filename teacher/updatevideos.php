	...
	<?php
							...
							if(isset($_FILES['file'])){
								...
								}else
								{
								    ...
								    $sql=	"update ignore videos set title='$name' , location='$random_name.$extension' ,size='$size' ,type='$type', video_title='$ti', subject='$si', upload_by='$user' , topic='$to' , date='$date'  where video_id='$video_id'";								
