  ...
  <span id="alert_action"></span>
	<div class="row">
		<div class="col-lg-12" style="font-size:18px;">
            ...
            <?php   
			 ...
			 $teacher_id=$_GET["teacher_id"];
                $res=mysqli_query($db,"select * from staff where teacher_id='$teacher_id'");
					...
					<table id="order_data" class="table table-bordered " style="margin-left:27%;">
						...
						<tr>
						    <td style="width:250px;">Subject</td>
							 <td style="width:250px;"><input type="text" class="form-control"  name="su" required  value="<?php echo $s  ?>"/></td>
     ...
     if(isset($_POST["b1"]))
	 {
			...
			$row= mysqli_query($db,"update ignore staff set firstname='$_POST[fn]',lastname='$_POST[ln]', email='$_POST[em]', mobile='$_POST[mn]' , subject='$_POST[su]'    where teacher_id='$teacher_id'");
