...
<?php include ('menu/menu3.php'); ?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-1 main">
            ...
            ?>
               ...
               <source src="upload/<?php echo $row['location']; ?>" type="video/mp4"></video></source>
						</div>
						<div class="slid-bottom-grid">
														<p class="views views-info btn btn-primary"  ><a  style="color:white;text-decoration:none;" href="updatevideos.php?video_id=<?php echo $row['video_id']; ?>" >Update </a></p>
													</div>
						
						<div class="slid-bottom-grid slid-bottom-right">
							<p class="views views-info btn btn-danger"  ><a  style="color:white;text-decoration:none;" href="deletevideos.php?video_id=<?php echo $row['video_id']; ?>" >Delete </a></p></p>
													</div>
