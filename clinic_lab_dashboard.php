...
<html lang="en">
  <head>
    ...
    <title>Priyanshi Dent Designs Solution Pvt Ltd</title>
    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          ...
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="clinic_lab_dashboard.php"><!--<img src="assets/images/logo-mini.svg" alt="logo" />-->
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/order/clinic_order.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/order/New_file_upload.php">
              <i class="mdi mdi-contacts menu-icon"></i>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
          <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
            <a class="navbar-brand brand-logo-mini align-self-center d-lg-none" href="home.php"><img src="assets/images/logo-mini.svg" alt="logo" /></a>
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Hi, welcome back! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">
              <?php
                    $res = mysqli_query($db, "select * from register_clinic where email='$clinic_user'");
			                   while($row=mysqli_fetch_array($res))
                            {
                      ...
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">New Case</p>
                            <h2 class="text-white"> 000000.<span class="h5">00</span>
                            </h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-basket bg-inverse-icon-warning"></i>
                        </div>
                        <h6 class="text-white">000000 Since last month</h6>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                    <div class="card bg-danger">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Inprogress</p>
                            <h2 class="text-white"> 00000.<span class="h5">00</span>
                            </h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-cube-outline bg-inverse-icon-danger"></i>
                        </div>
                        <h6 class="text-white">00000 Since last month</h6>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3 pb-lg-0 pb-xl-3">
                    <div class="card bg-primary">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Case On Hold</p>
                            <h2 class="text-white"> 000000<span class="h5">00</span>
                            </h2>
                          </div>
                  ...
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3 pb-lg-0 pb-xl-3">
                    <div class="card bg-success">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Redesign Cases</p>
                            <h2 class="text-white">00000</h2>
                          </div>
                  ...
                  <div class="col-xl-12 col-md-6 stretch-card pb-sm-3 pb-lg-0">
                    <div class="card bg-success">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Completed Cases</p>
                            <h2 class="text-white">00000</h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-account-circle bg-inverse-icon-success"></i>
                        </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-7">
                        <h5>Case status</h5>
                        <p class="text-muted"> % Wise Case Data<a class="text-muted font-weight-medium pl-2" href="#"><u>See Details</u></a>
                        </p>
                      </div>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Jai Siya Ram</span>
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href=# target="_blank">Create and design By Priyanshi Dent Designs Pvt Ltd</a> from Developer</span>
            </div>
          </footer>
        </div>
        <!-- main-panel ends -->
